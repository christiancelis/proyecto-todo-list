...
## Inicializacion del proyecto
    ...
    crear un entorno virtual phyton

    Situarse dentro del directorio backend, e ir a configuracion de visual studio code, panel de comandos y escribir "crear entorno virtual" luego seleccionar venv.
